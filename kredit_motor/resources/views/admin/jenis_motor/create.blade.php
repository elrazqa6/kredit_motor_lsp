...
@section('title', 'Tambah Jenis Motor')
@section('page-title', 'Tambah Jenis Motor Baru')
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="fw-bold mb-0">
                            <i class="fas fa-plus-circle text-primary me-2"></i> Form Tambah Jenis Motor
                        </h5>
                        <p class="text-muted mb-0 small">Isi data jenis motor dengan lengkap</p>
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('admin.jenis-motor.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_jenis" 
                               ...
                               placeholder="Contoh: Matic, Sport, Bebek" required>
                        @error('nama_jenis')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan" 
                                  ...
                                  rows="4" 
                                  placeholder="Deskripsi singkat tentang jenis motor ini">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" 
                                   id="isActive" role="switch" checked>
                    ...
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-4">
                            <i class="fas fa-save me-2"></i> Simpan Jenis Motor
                        </button>
                    </div>
                </form>
            </div>
